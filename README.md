...
| <a name="input_down_star_time"></a> [down\_star\_time](#input\_down\_star\_time) | description | `string` | `""` | no |
...
| <a name="input_up_star_time"></a> [up\_star\_time](#input\_up\_star\_time) | description | `string` | `""` | no |
